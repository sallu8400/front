...
const Profile = () => {
    ...
    const req = async () => {
      if (session) {
        ...
        try {
          ...
          setupdateAddress(!snapshort.empty);
  ...
  const HandleUpdateAdress = async (e) => {
    try {
      e.preventDefault();

      const ref = doc(db, "addresses", DocID);

      await updateDoc(ref, adressdata);
  ...
  return (
    <Layout>
      <div className=" md:py-12 md:w-6/12 mx-auto shadow-xl  mt-2 pb-16">
      ...
      <div className=" md:py-12 md:w-6/12 mx-auto shadow-xl  mt-6">
        <div className=" flex ml-6">
      ...
      <div className=" md:py-12 md:w-6/12 mx-auto shadow-xl  mt-5" id="update">
        <div className=" flex ml-6">
          <i className="ri-user-fill mr-2 text-3xl"></i>
        ...
        <form
          className="md:grid grid-cols-2 px-6 gap-4"
          onSubmit={updateAddress ? HandleUpdateAdress : AdressSave}
        >
          <div className="flex flex-col gap-2 col-span-2">
          ...
          {updateAddress ? (
            <button
              className="bg-rose-500 px-6 py-2 w-fit rounded  text-white font-semibold hover:bg-rose-600 mb-2 "
              id="add"
            >
            ...
            <button
              ...
              id="add"
            >
              <i className="ri-save-line mr-2"></i> Submit
            </button>
          )}
        </form>
      </div>
